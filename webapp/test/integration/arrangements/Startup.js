sap.ui.define([
	"sap/ui/test/Opa5",
	"com/jhae/test/JenkinsTest/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.jhae.test.JenkinsTest.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.jhae.test.JenkinsTest",
					async: true
				},
				hash: oOptions.hash,
